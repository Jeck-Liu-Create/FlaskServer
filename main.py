...
def edit_add():
    ...
    sqltxt = sqltxt + r"values ('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s');" % (c_diameter_before, c_date, c_roll_number,c_start_time, c_end_time, c_diameter ,c_grinding_machine, c_frame_id, c_roll_type, c_roll_position, c_roll_material, c_crown_symbol, c_roughness, c_side_bearing, c_drive_bearing, c_pairing_roll, c_top_diameter, c_low_diameter, c_cause, c_result_detection, c_crown_value, c_roundness, c_cylindricity, c_coaxiality, c_error)

    sqltxtid = r"select c_id from grinder_data where c_diameter_before = '%s' and c_date = '%s' and c_roll_number = '%s' and c_start_time = '%s' and c_end_time = '%s' and c_diameter = '%s' and c_grinding_machine = '%s' and c_frame_id = '%s' and c_roll_type = '%s' and c_roll_position = '%s' and c_roll_material = '%s' and c_crown_symbol = '%s' and c_roughness = '%s' and c_side_bearing = '%s' and c_drive_bearing = '%s' and c_pairing_roll = '%s' and c_top_diameter = '%s' and c_low_diameter = '%s' and c_cause = '%s' and c_result_detection = '%s' and c_crown_value = '%s' and c_roundness = '%s' and c_cylindricity = '%s' and  c_coaxiality = '%s' and c_error = '%s' LIMIT 1 ;" % (c_diameter_before,c_date,c_roll_number, c_start_time, c_end_time, c_diameter ,c_grinding_machine, c_frame_id, c_roll_type, c_roll_position, c_roll_material, c_crown_symbol, c_roughness, c_side_bearing, c_drive_bearing, c_pairing_roll, c_top_diameter, c_low_diameter, c_cause, c_result_detection, c_crown_value,c_roundness, c_cylindricity, c_coaxiality, c_error)
